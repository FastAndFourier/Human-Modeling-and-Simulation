...
measure = Metrics(m=maze,qtab=q_table,nb_traj=20,max_step=500,beta=2)
...
measure_obs = Metrics(m=maze_obs,qtab=q_table_obs,nb_traj=20,max_step=500,beta=2)
...
results.index = ["boltz 1","prospect 50","extremal 0.99",\
              "myopic VI 5","myopic VI 200"] 
