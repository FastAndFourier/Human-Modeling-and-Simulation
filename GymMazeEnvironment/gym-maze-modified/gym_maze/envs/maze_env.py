...
class MazeEnv(gym.Env):
    ...
    def reset(self,state=np.zeros(2,dtype=int)):
...
class MazeEnvSample40x40(MazeEnv):

    def __init__(self, enable_render=True):
        super(MazeEnvSample40x40, self).__init__(maze_file="maze2d_40x40.npy", enable_render=enable_render)
...
class MazeEnvSample60x60(MazeEnv):

    def __init__(self, enable_render=True):
        super(MazeEnvSample60x60, self).__init__(maze_file="maze2d_60x60.npy", enable_render=enable_render)

class MazeEnvSample70x70(MazeEnv):

    def __init__(self, enable_render=True):
        super(MazeEnvSample70x70, self).__init__(maze_file="maze2d_70x70.npy", enable_render=enable_render)

class MazeEnvSample80x80(MazeEnv):

    def __init__(self, enable_render=True):
        super(MazeEnvSample80x80, self).__init__(maze_file="maze2d_80x80.npy", enable_render=enable_render)

class MazeEnvSample90x90(MazeEnv):

    def __init__(self, enable_render=True):
        super(MazeEnvSample90x90, self).__init__(maze_file="maze2d_90x90.npy", enable_render=enable_render)
...
class MazeEnvRandom25x25(MazeEnv):
    ...
    def __init__(self, enable_render=True):
        super(MazeEnvRandom25x25, self).__init__(maze_size=(25,25), enable_render=enable_render)
